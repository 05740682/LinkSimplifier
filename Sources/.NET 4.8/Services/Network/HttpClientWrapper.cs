...
namespace LinkSimplifier.Services.Network
{
    internal static class HttpClientWrapper
    {
        ...
        static HttpClientWrapper()
        {
            ...
            _client.DefaultRequestHeaders.Accept.ParseAdd(NetworkConfig.DefaultAccept);
            _client.DefaultRequestHeaders.AcceptLanguage.ParseAdd(NetworkConfig.DefaultAcceptLanguage);
            _client.DefaultRequestHeaders.UserAgent.ParseAdd(NetworkConfig.DefaultUserAgent);
        }
