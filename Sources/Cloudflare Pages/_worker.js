...
<div class="desktop-icon-text">项目仓库</div>
</div>
<div class="window-container" id="windowContainer">
<div class="title-bar">
<div class="title-bar-drag">
<div class="window-title">LinkSimplifier</div>
</div>
<div class="window-controls">
<button class="window-btn minimize disabled" id="minimizeBtn" title="最小化" disabled><svg viewBox="0 0 10 1"><rect x="0" y="0" width="10" height="1" fill="currentColor"/></svg></button>
<button class="window-btn maximize" id="maximizeBtn" title="最大化"><svg viewBox="0 0 10 10"><rect x="0" y="0" width="9" height="9" fill="none" stroke="currentColor" stroke-width="1"/></svg></button>
<button class="window-btn close" id="closeBtn" title="关闭"><svg viewBox="0 0 10 10"><path d="M1,1 L9,9 M9,1 L1,9" stroke="currentColor" stroke-width="1" fill="none"/></svg></button>
</div>
</div>
...
<input type="text" class="input-box" id="urlInput" placeholder=" ">
<div class="placeholder" id="placeholder">请填写云盘分享链接...</div>
</div>
<button class="btn btn-primary" id="parseBtn">开始解析</button>
<button class="btn btn-primary btn-small" id="clearBtn">清空</button>
</div>
</div>
<div class="card result-section">
<textarea class="result-box" id="resultText" readonly></textarea>
</div>
</div>
</div>
